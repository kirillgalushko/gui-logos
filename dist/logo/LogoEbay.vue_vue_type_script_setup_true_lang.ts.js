import { defineComponent as i, computed as c, openBlock as h, createElementBlock as n, normalizeStyle as s, createElementVNode as e } from "vue";
const u = /* @__PURE__ */ i({
  __name: "LogoEbay",
  props: {
    width: {},
  ...
  setup(t) {
    ...
    return (m, o) => (h(), n("svg", {
      ...
      e("path", {
        fill: "#0064D2FF",
        "fill-color-id": "1",
        d: "M75.438.1v83.597c0 4.745-.339 11.408-.339 11.408h14.939s.537-4.785.537-9.159c0 0 7.381 11.548 27.451 11.548 21.134 0 35.49-14.674 35.49-35.695 0-19.557-13.186-35.286-35.456-35.286-20.854 0-27.334 11.261-27.334 11.261V.1zm38.766 36.753c14.352 0 23.479 10.652 23.479 24.946 0 15.328-10.541 25.355-23.376 25.355-15.318 0-23.581-11.961-23.581-25.219 0-12.354 7.414-25.082 23.478-25.082",
        "recolor-fill": "true",
        "recolor-stroke": "true"
      }, null, -1),
      e("path", {
      ...
      e("path", {
        fill: "#86B817FF",
        "fill-color-id": "3",
        d: "M214.879 29.041h17.813l25.565 51.218 25.506-51.218H299.9l-46.459 91.184h-16.927l13.406-25.419z",
        "recolor-fill": "true",
        "recolor-stroke": "true"
      }, null, -1)
    ]), 4));
