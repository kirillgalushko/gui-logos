import { defineComponent as r, computed as i, openBlock as h, createElementBlock as n, normalizeStyle as m, createElementVNode as t } from "vue";
const p = /* @__PURE__ */ r({
  __name: "LogoKfc",
  props: {
    width: {},
  ...
  setup(o) {
    ...
    return (s, e) => (h(), n("svg", {
      ...
      width: "1000",
      height: "476",
      viewBox: "11.238 10.874 994.856 473.585",
      style: m(c.value)
    }, e[0] || (e[0] = [
      t("path", {
        fill: "#A3080BFF",
        "fill-color-id": "0",
        d: "M11.238 484.459h994.856V10.874H11.238z",
        "recolor-fill": "true",
        "recolor-stroke": "true"
      }, null, -1),
      t("path", {
