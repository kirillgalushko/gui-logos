import { defineComponent as i, computed as o, openBlock as n, createElementBlock as m, normalizeStyle as p, createElementVNode as t } from "vue";
const s = /* @__PURE__ */ i({
  __name: "LogoDependabot",
  props: {
    width: {},
    height: {}
  },
  setup(l) {
    ...
    return (c, a) => (n(), m("svg", {
      ...
      t("g", null, [
        t("path", {
          fill: "#2B64CF",
          d: "M118.84 2.179c5.083-2.902 13.312-2.909 18.406 0l109.551 71.514C251.88 76.595 256 83.68 256 89.542v93.345c0 5.85-4.109 12.94-9.203 15.848l-109.551 72.55c-5.083 2.902-13.312 2.909-18.406 0L9.203 198.736C4.12 195.833 0 188.75 0 182.887V89.542c0-5.851 4.109-12.94 9.203-15.849z"
        }),
        t("path", {
          fill: "#FFF",
