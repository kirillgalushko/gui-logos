import { defineComponent as c, computed as h, openBlock as s, createElementBlock as n, normalizeStyle as o, createElementVNode as e } from "vue";
const r = /* @__PURE__ */ c({
  __name: "LogoNextjs",
  props: {
    width: {},
  ...
  setup(l) {
    ...
    return (m, i) => (s(), n("svg", {
      ...
      e("g", { "clip-path": "url(#nextjs-gui-asset-a)" }, [
        e("path", {
          fill: "#000",
      ...
      e("defs", null, [
        e("clipPath", { id: "nextjs-gui-asset-a" }, [
          e("rect", {
            width: "24",
            height: "24",
            fill: "#fff"
